...
function populateUserInfo() {
    // prints user's browser name using faster, more secure textContent instead of innerHTML
    document.getElementById("userBrowser").textContent = navigator.appName;
    ...
    document.getElementById("userWindowSize").textContent = window.outerWidth + " x " + window.outerHeight + " (" + window.outerWidth + " pixels wide by " + window.outerHeight + " pixels tall)";

    // print's user's available size for web content, not counting space for OS menus
    document.getElementById("userAvailContentSize").textContent = screen.availWidth + " x " + screen.availHeight + " (" + screen.availWidth + " pixels wide by " + screen.availHeight + " pixels tall)";
    
    // prints user's color depth
    document.getElementById("userColorDepth").textContent = screen.colorDepth + " bits";
}
